        ...
        <div id="kt_app_toolbar" class="py-3 app-toolbar py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                    <!--begin::Title-->
                    <h1 class="my-0 text-gray-900 page-heading d-flex fw-bold fs-3 flex-column justify-content-center">Multipurpose</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="mb-5 row g-5 gx-xl-10 mb-xl-10">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                        ...
                        <div class="mb-5 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-xl-10" style="background-color: #F1416C;background-image:url('assets/media/patterns/vector-1.png')">
                            <!--begin::Header-->
                        ...
                        <div class="mb-5 card card-flush h-md-50 mb-xl-10">
                            ...
                            <div class="pt-5 card-header">
                                ...
                                <div class="card-title d-flex flex-column">
                                    <!--begin::Amount-->
                                    <span class="text-gray-900 fs-2hx fw-bold me-2 lh-1 ls-n2">357</span>
                                    <!--end::Amount-->
                                    <!--begin::Subtitle-->
                                    <span class="pt-1 text-gray-500 fw-semibold fs-6">Professionals</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                        ...
                        <div class="mb-5 card card-flush h-md-50 mb-xl-10">
                            ...
                            <div class="pt-5 card-header">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!--end::Info-->
                                    <!--begin::Subtitle-->
                                    <span class="pt-1 text-gray-500 fw-semibold fs-6">Projects Earnings in April</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                            <!--end::Header-->
                            <!--begin::Card body-->
                            <div class="flex-wrap pt-2 pb-4 card-body d-flex align-items-center">
                                <!--begin::Chart-->
                                ...
                                <div class="d-flex flex-column content-justify-center flex-row-fluid">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Label-->
                                    <div class="my-3 d-flex fw-semibold align-items-center">
                                        <!--begin::Bullet-->
                        ...
                        <div class="card card-flush h-lg-50">
                            ...
                            <div class="pt-5 card-header">
                                <!--begin::Title-->
                                <h3 class="text-gray-800 card-title fw-bold">External Links</h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                            ...
                            <div class="pt-5 card-body">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <!--end::Section-->
                                    <!--begin::Action-->
                                    <button type="button" class="h-auto btn btn-icon btn-sm btn-color-gray-500 btn-active-color-primary justify-content-end">
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card card-flush h-md-100">
                            <!--begin::Body-->
                            <div class="pb-0 card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center" style="background-position: 100% 50%; background-image:url('assets/media/stock/900x600/42.png')">
                                <!--begin::Wrapper-->
                                <div class="mb-10">
                                    <!--begin::Title-->
                                    <div class="text-center text-gray-800 fs-2hx fw-bold mb-13">
                                    ...
                                    <span class="position-relative d-inline-block text-danger">
                                        ...
                                        <!--begin::Separator-->
                                        <span class="bottom-0 border-4 position-absolute opacity-15 start-0 border-danger border-bottom w-100"></span>
                                        <!--end::Separator-->
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="pt-5 card-header">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="text-gray-900 card-label fw-bold">Performance Overview</span>
                                ...
                                <div class="card-toolbar">
                                    <ul class="nav" id="kt_chart_widget_8_tabs">
                                        <li class="nav-item">
                                            <a class="px-4 nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold me-1" data-bs-toggle="tab" id="kt_chart_widget_8_week_toggle" href="#kt_chart_widget_8_week_tab">Month</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="px-4 nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold me-1 active" data-bs-toggle="tab" id="kt_chart_widget_8_month_toggle" href="#kt_chart_widget_8_month_tab">Week</a>
                                        </li>
                                    </ul>
                                </div>
                                <!--end::Toolbar-->
                                    ...
                                    <div class="tab-pane fade" id="kt_chart_widget_8_week_tab" role="tabpanel">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div class="mb-2 d-flex align-items-center">
                                                <span class="text-gray-500 fs-1 fw-semibold me-1 mt-n1">$</span>
                                                <span class="text-gray-800 fs-3x fw-bold me-2 lh-1 ls-n2">18,89</span>
                                                <span class="badge badge-light-success fs-base">
                                                <i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                            ...
                                            <!--end::Statistics-->
                                            <!--begin::Description-->
                                            <span class="text-gray-500 fs-6 fw-semibold">Avarage cost per interaction</span>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Statistics-->
                                        <!--begin::Chart-->
                                        ...
                                        <!--end::Chart-->
                                        <!--begin::Items-->
                                        <div class="flex-wrap pt-5 d-flex">
                                            <!--begin::Item-->
                                            <div class="pt-6 d-flex flex-column me-7 me-lg-16 pt-sm-3">
                                                <!--begin::Item-->
                                                <div class="mb-3 d-flex align-items-center mb-sm-6">
                                                    <!--begin::Bullet-->
                                                    <span class="bullet bullet-dot bg-primary me-2 h-10px w-10px"></span>
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <span class="text-gray-600 fw-bold fs-6">Social Campaigns</span>
                                                    <!--end::Label-->
                                                </div>
                                                <!--ed::Item-->
                                                <!--begin::Item-->
                                            ...
                                            <div class="pt-6 d-flex flex-column me-7 me-lg-16 pt-sm-3">
                                                ...
                                                <div class="mb-3 d-flex align-items-center mb-sm-6">
                                                    ...
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <span class="text-gray-600 fw-bold fs-6">Email Newsletter</span>
                                                    <!--end::Label-->
                                                </div>
                                                <!--ed::Item-->
                                                <!--begin::Item-->
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <span class="text-gray-600 fw-bold fs-6">Courses</span>
                                                    <!--end::Label-->
                                                </div>
                                                <!--ed::Item-->
                                            </div>
                                            <!--ed::Item-->
                                            <!--begin::Item-->
                                            <div class="pt-6 d-flex flex-column pt-sm-3">
                                                <!--begin::Item-->
                                                <div class="mb-3 d-flex align-items-center mb-sm-6">
                                                    <!--begin::Bullet-->
                                                    ...
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <span class="text-gray-600 fw-bold fs-6">TV Campaign</span>
                                                    <!--end::Label-->
                                                </div>
                                                <!--ed::Item-->
                                                <!--begin::Item-->
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <span class="text-gray-600 fw-bold fs-6">Radio</span>
                                                    <!--end::Label-->
                                                </div>
                                                <!--ed::Item-->
                                            </div>
                                        ...
                                        <div class="flex-wrap pt-5 d-flex">
                                            ...
                                            <div class="pt-6 d-flex flex-column me-7 me-lg-16 pt-sm-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <span class="text-gray-600 fw-bold fs-6">Google Ads</span>
                                                    <!--end::Label-->
                                                </div>
                                                <!--ed::Item-->
                                            </div>
                    ...
                    <div class="mb-5 col-xl-6 mb-xl-10">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="pt-5 card-header">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="text-gray-800 card-label fw-bold">Authors Achievements</span>
                                    <span class="mt-1 text-gray-500 fw-semibold fs-6">Avg. 69.34% Conv. Rate</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                            ...
                            <div class="pt-6 card-body">
                                ...
                                <ul class="mb-3 nav nav-pills nav-pills-custom">
                                    ...
                                    <li class="mb-3 nav-item me-3 me-lg-6">
                                        <!--begin::Link-->
                                        <a class="pt-5 pb-2 overflow-hidden nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column w-80px h-85px active" id="kt_stats_widget_16_tab_link_1" data-bs-toggle="pill" href="#kt_stats_widget_16_tab_1">
                                            <!--begin::Icon-->
                                            <div class="mb-3 nav-icon">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <span class="text-gray-800 nav-text fw-bold fs-6 lh-1">SaaS</span>
                                            <!--end::Title-->
                                            <!--begin::Bullet-->
                                            <span class="bottom-0 bullet-custom position-absolute w-100 h-4px bg-primary"></span>
                                            <!--end::Bullet-->
                                        </a>
                                        <!--end::Link-->
                                    </li>
                                    ...
                                    <li class="mb-3 nav-item me-3 me-lg-6">
                                        <!--begin::Link-->
                                        <a class="pt-5 pb-2 overflow-hidden nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column w-80px h-85px" id="kt_stats_widget_16_tab_link_2" data-bs-toggle="pill" href="#kt_stats_widget_16_tab_2">
                                            <!--begin::Icon-->
                                            <div class="mb-3 nav-icon">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <span class="text-gray-800 nav-text fw-bold fs-6 lh-1">Crypto</span>
                                            <!--end::Title-->
                                            <!--begin::Bullet-->
                                            <span class="bottom-0 bullet-custom position-absolute w-100 h-4px bg-primary"></span>
                                            <!--end::Bullet-->
                                    ...
                                    <li class="mb-3 nav-item me-3 me-lg-6">
                                        <!--begin::Link-->
                                        <a class="pt-5 pb-2 overflow-hidden nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column w-80px h-85px" id="kt_stats_widget_16_tab_link_3" data-bs-toggle="pill" href="#kt_stats_widget_16_tab_3">
                                            <!--begin::Icon-->
                                            <div class="mb-3 nav-icon">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <span class="text-gray-800 nav-text fw-bold fs-6 lh-1">Social</span>
                                            <!--end::Title-->
                                            <!--begin::Bullet-->
                                            <span class="bottom-0 bullet-custom position-absolute w-100 h-4px bg-primary"></span>
                                            <!--end::Bullet-->
                                    ...
                                    <li class="mb-3 nav-item me-3 me-lg-6">
                                        <!--begin::Link-->
                                        <a class="pt-5 pb-2 overflow-hidden nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column w-80px h-85px" id="kt_stats_widget_16_tab_link_4" data-bs-toggle="pill" href="#kt_stats_widget_16_tab_4">
                                            <!--begin::Icon-->
                                            <div class="mb-3 nav-icon">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <span class="text-gray-800 nav-text fw-bold fs-6 lh-1">Mobile</span>
                                            <!--end::Title-->
                                            <!--begin::Bullet-->
                                            <span class="bottom-0 bullet-custom position-absolute w-100 h-4px bg-primary"></span>
                                            <!--end::Bullet-->
                                    ...
                                    <li class="mb-3 nav-item me-3 me-lg-6">
                                        <!--begin::Link-->
                                        <a class="pt-5 pb-2 overflow-hidden nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column w-80px h-85px" id="kt_stats_widget_16_tab_link_5" data-bs-toggle="pill" href="#kt_stats_widget_16_tab_5">
                                            <!--begin::Icon-->
                                            <div class="mb-3 nav-icon">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <span class="text-gray-800 nav-text fw-bold fs-6 lh-1">Others</span>
                                            <!--end::Title-->
                                            <!--begin::Bullet-->
                                            <span class="bottom-0 bullet-custom position-absolute w-100 h-4px bg-primary"></span>
                                            <!--end::Bullet-->
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Guy Hawkins</a>
                                                        ...
                                                        <td class="text-end">
                                                            <a href="#" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                                                                <i class="text-gray-500 ki-duotone ki-black-right fs-2"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Jane Cooper</a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Jacob Jones</a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Cody Fishers</a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Brooklyn Simmons</a>
                                                                    <span class="text-gray-500 fw-semibold d-block fs-7">Poland</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Esther Howard</a>
                                                                    <span class="text-gray-500 fw-semibold d-block fs-7">Mexico</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Annette Black</a>
                                                                    <span class="text-gray-500 fw-semibold d-block fs-7">Haiti</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Marvin McKinney</a>
                                                                    <span class="text-gray-500 fw-semibold d-block fs-7">Monaco</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Ronald Richards</a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Leslie Alexander</a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Courtney Henry</a>
                                                                    <span class="text-gray-500 fw-semibold d-block fs-7">Mexico</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Arlene McCoy</a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Marvin McKinneyr</a>
                                                                    <span class="text-gray-500 fw-semibold d-block fs-7">Monaco</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="pages/user-profile/overview.html" class="mb-1 text-gray-800 fw-bold text-hover-primary fs-6">Ralph Edwards</a>
                                                                    <span class="text-gray-500 fw-semibold d-block fs-7">Mexico</span>
                                                                </div>
                                                            </div>
                                                        </td>
                ...
                <div class="mb-5 row g-5 g-xl-10 mb-xl-10">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-body py-9">
                                ...
                                <div class="row gx-9 h-100">
                                    <!--begin::Col-->
                                    <div class="mb-10 col-sm-6 mb-sm-0">
                                        <!--begin::Image-->
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="d-flex flex-column h-100">
                                            ...
                                            <div class="mb-7">
                                                ...
                                                <div class="mb-6 d-flex flex-stack">
                                                    ...
                                                    <div class="flex-shrink-0 me-5">
                                                        <span class="pb-1 text-gray-500 fs-7 fw-bold me-2 d-block lh-1">Featured</span>
                                                        <span class="text-gray-800 fs-1 fw-bold">9 Degree</span>
                                                    </div>
                                                    <!--end::Title-->
                                                    <span class="flex-shrink-0 px-4 py-3 badge badge-light-primary align-self-center fs-7">In Process</span>
                                                </div>
                                                <!--end::Heading-->
                                                <!--begin::Items-->
                                                <div class="flex-wrap gap-2 d-flex align-items-center d-grid">
                                                    <!--begin::Item-->
                                                    <div class="d-flex align-items-center me-5 me-xl-13">
                                                        ...
                                                        <!--begin::Info-->
                                                        <div class="m-0">
                                                            <span class="text-gray-500 fw-semibold d-block fs-8">Manager</span>
                                                            <a href="pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary fs-7">Robert Fox</a>
                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                    <!--end::Item-->
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-30px symbol-circle me-3">
                                                            <span class="symbol-label bg-success">
                                                                <i class="text-white ki-duotone ki-abstract-41 fs-5">
                                                                    <span class="path1"></span>
                                                                    <span class="path2"></span>
                                                                </i>
                                                            </span>
                                                        ...
                                                        <!--begin::Info-->
                                                        <div class="m-0">
                                                            <span class="text-gray-500 fw-semibold d-block fs-8">Budget</span>
                                                            <span class="text-gray-800 fw-bold fs-7">$64.800</span>
                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                    <!--end::Item-->
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Text-->
                                                <span class="mb-8 text-gray-600 fw-semibold fs-6 d-block">Flat cartoony illustrations with vivid unblended colors and asymmetrical beautiful purple hair lady</span>
                                                <!--end::Text-->
                                                <!--begin::Stats-->
                                                <div class="d-flex">
                                                    <!--begin::Stat-->
                                                    <div class="px-4 py-2 mb-3 border border-gray-300 border-dashed rounded min-w-100px w-100 me-6">
                                                        <!--begin::Date-->
                                                        <span class="text-gray-700 fs-6 fw-bold">Feb 6, 2021</span>
                                                        <!--end::Date-->
                                                        <!--begin::Label-->
                                                        <div class="text-gray-500 fw-semibold">Due Date</div>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Stat-->
                                                    <!--begin::Stat-->
                                                    <div class="px-4 py-2 mb-3 border border-gray-300 border-dashed rounded min-w-100px w-100">
                                                        <!--begin::Number-->
                                                        <span class="text-gray-700 fs-6 fw-bold">$
                                                        <span class="ms-n1" data-kt-countup="true" data-kt-countup-value="284,900.00">0</span></span>
                                                        <!--end::Number-->
                                                        <!--begin::Label-->
                                                        <div class="text-gray-500 fw-semibold">Budget</div>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Stat-->
                                                </div>
                                            ...
                                            <!--end::Body-->
                                            <!--begin::Footer-->
                                            <div class="mt-auto d-flex flex-stack bd-highlight">
                                                <!--begin::Users group-->
                                                <div class="symbol-group symbol-hover flex-nowrap">
                                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Melody Macy">
                                                        <img alt="Pic" src="assets/media/avatars/300-2.jpg" />
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="overflow-hidden card card-flush h-lg-100">
                            <!--begin::Header-->
                            <div class="pt-5 card-header">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="text-gray-900 card-label fw-bold">Performance</span>
                                    <span class="mt-1 text-gray-500 fw-semibold fs-6">1,046 Inbound Calls today</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    <!--begin::Daterangepicker(defined in src/js/layout/app.js)-->
                                    <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left" data-kt-daterangepicker-range="today" class="px-4 btn btn-sm btn-light d-flex align-items-center">
                                        <!--begin::Display range-->
                                        <div class="text-gray-600 fw-bold">Loading date range...</div>
                                        <!--end::Display range-->
                                        <i class="text-gray-500 ki-duotone ki-calendar-8 lh-0 fs-2 ms-2 me-0">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                            <span class="path3"></span>
                                            <span class="path4"></span>
                            ...
                            <!--end::Header-->
                            <!--begin::Card body-->
                            <div class="p-0 card-body d-flex align-items-end">
                                <!--begin::Chart-->
                ...
                <div class="mb-5 row g-5 g-xl-10 mb-xl-10">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-flush h-md-100">
                            <!--begin::Header-->
                            <div class="pt-5 mb-6 card-header">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <!--begin::Statistics-->
                                    <div class="mb-2 d-flex align-items-center">
                                        <!--begin::Currency-->
                                        <span class="text-gray-500 fs-3 fw-semibold align-self-start me-1">$</span>
                                        <!--end::Currency-->
                                        <!--begin::Value-->
                                        <span class="text-gray-800 fs-2hx fw-bold me-2 lh-1 ls-n2">3,274.94</span>
                                        <!--end::Value-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light-success fs-base">
                                        <i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
                                    ...
                                    <!--end::Statistics-->
                                    <!--begin::Description-->
                                    <span class="text-gray-500 fs-6 fw-semibold">Avg. Agent Earnings</span>
                                    <!--end::Description-->
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                            ...
                            <div class="px-0 py-0 card-body">
                                <!--begin::Nav-->
                                <ul class="mb-3 nav d-flex justify-content-between mx-9">
                                    <!--begin::Item-->
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-header pt-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="text-gray-800 card-label fw-bold">Projects Stats</span>
                                    <span class="mt-1 text-gray-500 fw-semibold fs-6">Updated 37 minutes ago</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                ...
                <div class="row gx-5 gx-xl-10">
                    ...
                    <div class="mb-5 col-xl-4 mb-xl-0">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7 mb-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="text-gray-800 card-label fw-bold">Warephase stats</span>
                                    <span class="mt-1 text-gray-500 fw-semibold fs-6">8k social visitors</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="overflow-hidden card card-flush h-xl-100">
                            <!--begin::Header-->
                            <div class="py-5 card-header">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="text-gray-900 card-label fw-bold">Human Resources</span>
                                    <span class="mt-1 text-gray-500 fw-semibold fs-6">Reports by states and ganders</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
