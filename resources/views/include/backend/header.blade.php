                                    ...
                                    <div class="px-3 py-3 mb-3 col-lg-8 mb-lg-0 py-lg-6 px-lg-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-lg-6">
                                                ...
                                                <div class="p-0 m-0 menu-item">
                                                    <!--begin:Menu link-->
                                                    <a href="backend/ecommerce.blade.php" class="menu-link">
                                                        <span class="flex-shrink-0 rounded menu-custom-icon d-flex flex-center w-40px h-40px me-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-6 col-lg-3 mb-lg-0">
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        <!--begin:Menu link-->
                                                        <a href="authentication/email/ptionription-confirmed.html" class="menu-link">
            ...
            <div class="flex-shrink-0 app-navbar">
                        ...
                        <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                            ...
                            <div data-kt-search-element="wrapper">
                                ...
                                <form data-kt-search-element="form" class="mb-3 w-100 position-relative" autocomplete="off">
                                    <!--begin::Icon-->
                                    <i class="text-gray-500 ki-duotone ki-magnifier fs-2 position-absolute top-50 translate-middle-y ms-0">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                    </i>
                                    <!--end::Icon-->
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="px-5 menu-item" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
                            <a href="#" class="px-5 menu-link">
                                <span class="menu-title">Authen</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="py-4 menu-sub menu-sub-dropdown w-175px">
                                <!--begin::Menu item-->
                                <div class="px-3 menu-item">
                                    <a href="{{ url ('login')}}" class="px-5 menu-link">Login</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="px-3 menu-item">
                                    <a href="{{ url ('register')}}" class="px-5 menu-link">Register</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu separator-->
                                <div class="my-2 separator"></div>
